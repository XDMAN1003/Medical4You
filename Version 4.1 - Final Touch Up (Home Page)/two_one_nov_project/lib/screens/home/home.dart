                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height:7.0),
                                      Text(userData.short_comment ?? "---(No Comment is found)---",
                                          style: TextStyle(
                                              fontSize: 15,
                                              color: Colors.white)),
                                    ],
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height:7.0),
                                      Text(userData.appointmentDate == null ?"---(No Appointment found)---" : DateFormat('dd MMMM yyyy').format(userData.appointmentDate.toDate()),
                                          style: TextStyle(
                                              fontSize: 15,
                                              color: Colors.white)),
                                    ],
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height:7.0),
                                      Text(userData.payment_date ?? "---(No Payment)---",
                                          style: TextStyle(
                                              fontSize: 15,
                                              color: Colors.white)),
                                    ],
