              ...
              child: FlatButton(
                ...
                child: Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(5, 10.0, 20.0, 5.0),
                      child: Icon(Icons.medical_services_outlined,color: Colors.grey[700],size: 30.0,),
                    ),
                    Expanded(
                      flex: 2,
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Health Report",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.grey[700]),),
                            Text("Check health report from the list", style: TextStyle(fontSize: 15, color: Colors.grey[700])),
                          ],
                        ),
                      ),
                    ),
              ...
              child: FlatButton(
                ...
                child: Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(5, 10.0, 20.0, 5.0),
                      child: Icon(Icons.monetization_on,color: Colors.grey[700],size: 30.0,),
                    ),
                    Expanded(
                      flex: 2,
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Billing",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.grey[700]),),
                            Text("Check the bill from the list", style: TextStyle(fontSize: 15, color: Colors.grey[700])),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Emergency Call",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.grey[700]),),
                            Text("Call Someone important to you", style: TextStyle(fontSize: 15, color: Colors.grey[700])),
                          ],
                        ),
                      ),
                    ),
